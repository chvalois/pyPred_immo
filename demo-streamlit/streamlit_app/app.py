...
from tabs import _intro, ii_prix_annonces, iii_prix_features, i_prix_dvf, iv_annonce, iv_demo
...
TABS = OrderedDict(
    [
        ...
        (i_prix_dvf.sidebar_name, i_prix_dvf),
        (ii_prix_annonces.sidebar_name, ii_prix_annonces),
