...
def run():
    ...
    st.markdown(
        ...
        - **Analyse des prix officiels 2022 + S1 2023** : visualisation des prix de vente des biens immobiliers en France à partir de la base DVF 2020 (Demande de Valeurs Foncières)
        ...
        - **Prédiction de prix** : prédit si le prix d'un bien immobilier est sur-évalué ou sous-évalué par rapport au marché 2023
        """
    )
